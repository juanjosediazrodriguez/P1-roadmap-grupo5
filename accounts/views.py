...
def save_preferences(request):
    if request.method == 'POST':
        ...
        if not (selected_interests or selected_technologies or selected_goal):
        ...
        if selected_technologies:
            # Convertir a integers
            tech_ids = [int(id) for id in selected_technologies if id]
            preference.technologies.set(tech_ids)
        else:
            preference.technologies.clear()
