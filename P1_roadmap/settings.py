"""
Django settings for P1_roadmap project.
...
ALLOWED_HOSTS = ['75.101.171.124', '3.89.48.74', '54.81.231.10', '127.0.0.1', 'localhost', '98.92.164.208', '34.207.136.182', '54.221.179.241']
...
ROOT_URLCONF = 'P1_roadmap.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'P1_roadmap/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'P1_roadmap.wsgi.application'
